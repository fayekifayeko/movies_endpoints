...
{
    public class InAppStorageService : IFileStorageService // there is a video for storage in Azure
    {
        ...
        public Task DeleteFile(string fileRoute, string containerName)
        {
            ...
            var directory = Path.Combine(env.WebRootPath, containerName, fileName);
        ...
        public async Task<string> SaveFile(string containerName, IFormFile file)
        {
            ...
            var routeToDb = Path.Combine(url, containerName, fileName).Replace("\\", "/");
